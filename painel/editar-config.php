...
$query = $pdo->prepare("UPDATE $tabela SET nome = :nome, email = :email, telefone = :telefone, endereco = :endereco, marca_dagua = '$marca_dagua', dias_entrega = '$dias_entrega', api_whatsapp = '$api_whatsapp', token_api = :token_api, instancia_api = :instancia_api, emprestimos_leitor = '$emprestimos_leitor' where id = 1");
