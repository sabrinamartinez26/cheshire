	...
	<div class="col_3">
		...
		<div class="col-md-3 widget widget1">
			<div class="r3_counter_box">
				<i class="pull-left fa fa-book total icon-rounded"></i>
				<div class="stats">
		...
		<div class="col-md-3 widget widget1">
			<div class="r3_counter_box">
				<i class="pull-left fa fa-exchange-alt emprestados icon-rounded"></i>
				<div class="stats">
		...
		<div class="col-md-3 widget widget1">
			<div class="r3_counter_box">
				<i class="pull-left fa fa-hand-holding-heart entregas icon-rounded"></i>
				<div class="stats">
		...
		<div class="col-md-3 widget widget1">
			<div class="r3_counter_box">
				<i class="pull-left fa fa-calendar-xmark atraso icon-rounded"></i>
				<div class="stats">
		...
		<div class="col-md-3 widget">
			<div class="r3_counter_box">
				<i class="pull-left fa fa-book-open-reader leitores icon-rounded"></i>
	...
	<div class="row-one widgettable">
		<div class="col-md-8 content-top-2 card" style="padding:20px">
			<div class="card-header">
				...
				<canvas id="canvas" style="width: 100%; height:355px;"></canvas>
	...
	<div class="row-one widgettable">
		<div class="col-md-12 content-top-2 card">
			<div class="agileinfo-cdr">
				<div class="card-header">
					<h3>Empréstimos Anuais</h3>
				</div>
				
				<div id="Linegraph" style="width: 98%; height: 330px">
				</div>
