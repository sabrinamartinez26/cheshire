...
if($id == ""){
$query = $pdo->prepare("INSERT INTO $tabela SET codigo = :codigo, titulo = :titulo, subtitulo = :subtitulo, autor = :autor, ano = '$ano', editora = '$editora', edicao = :edicao, categoria = '$categoria', foto = '$foto', local = '$local', status = 'Disponível', obs = :obs, data_cad = curDate(), estoque = '$estoque', quantidade = '$quantidade'");
	
}else{
$query = $pdo->prepare("UPDATE $tabela SET codigo = :codigo, titulo = :titulo, subtitulo = :subtitulo, autor = :autor,  ano = '$ano', editora = '$editora', edicao = :edicao, categoria = '$categoria', foto = '$foto', local = '$local', obs = :obs, estoque = '$estoque', quantidade = '$quantidade' where id = '$id'");
}
