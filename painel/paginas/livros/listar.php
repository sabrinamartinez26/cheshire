...
<td>
	<big><a href="#" onclick="editar('{$id}','{$codigo}','{$titulo}','{$subtitulo}','{$autor}','{$ano}','{$editora}','{$edicao}','{$categoria}','{$foto}','{$local}','{$obs}','{$estoque}','{$quantidade}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<big><a href="#" onclick="mostrar('{$codigo}','{$titulo}','{$subtitulo}','{$autor}','{$ano}','{$nome_editora}','{$edicao}','{$nome_categoria}','{$foto}','{$nome_local}','{$status}','{$obs}','{$dataF}','{$estoque}','{$quantidade}')" title="Mostrar Dados"><i class="fa fa-info-circle text-primary"></i></a></big>
