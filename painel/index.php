...
<head>
	...
	<script src="https://kit.fontawesome.com/5a8916cd98.js" crossorigin="anonymous"></script>
			...
			<aside class="sidebar-left" style="">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-cat littlecat"></span>      Cheshire<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo $menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $leitores ?>"><a href="leitores"><i class="fa fa-angle-right"></i> Leitores</a></li>
							...
							<li class="treeview <?php echo $menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $livros ?>"><a href="livros"><i class="fa fa-angle-right"></i> Livros</a></li>
									...
									<li class="<?php echo $locais ?>"><a href="locais"><i class="fa fa-angle-right"></i> Locais</a></li>

									<li class="<?php echo $editoras ?>"><a href="editoras"><i class="fa fa-angle-right"></i> Editoras</a></li>
							...
							<li class="treeview <?php echo $menu_emprestimos ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $emprestimos_ativos ?>"><a href="emprestimos"><i class="fa fa-angle-right"></i>Empréstimos Ativos</a></li>
									...
									<li class="<?php echo $todos_emprestimos ?>"><a href="emprestimos_todos"><i class="fa fa-angle-right"></i>Todos os Empréstimos</a></li>
							...
							<li class="treeview <?php echo $solicitacoes ?>">
								<a href="solicitacoes">
									<i class="fa fa-thumbtack"></i> <span>Solicitações</span>
								</a>
							</li>
				...
				<div class="profile_details_left"><!--notifications of menu start -->
					...
					<ul class="nofitications-dropdown">
							...
							<ul class="dropdown-menu">
								<li>
									<div class="notifiascrail2000cation_header">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">							
								<label>Email</label>
								<input type="email" class="form-control" id="email_perfil" name="email" placeholder="Seu E-mail" value="<?php echo $email_usuario ?>" required>							
						</div>
					</div>
